  ...
  <nav class="navbar navbar-dark bg-dark">
	...
	<div class="card-intro-img-adm"><img class="card-img-top" src="img/logo_sm.jpg" alt="Card image cap"></div>			
			<div class="card-body card-body-adm-tt">
				...
				<p class="card-text cd-s-sm">Olá Querido Aluno, aqui você poderá ver os resumos das matérias e enviar o seu resumo.</p></div>
	<div class="row"><div class="card-body card-body-adm-tt"></div>	
			</div>			
			<div class="row"> 
			<div class="col-sm-4 col-md-4 col-lg-4"><div class="card-body card-body-adm-lt"><img class="ikon" src="open-iconic-master/png/sun-8x.png" alt="Card image cap">
			</div></div>
			<div class="col-sm-4 col-md-4 col-lg-4"><div class="card-body card-body-adm-lt"><img class="ikon" src="open-iconic-master/png/sun-8x.png" alt="Card image cap">
			</div></div>
			<div class="col-sm-4 col-md-4 col-lg-4"><div class="card-body card-body-adm-lt"><img class="ikon" src="open-iconic-master/png/sun-8x.png" alt="Card image cap">
			...
			<div class="card-body card-body-adm-tt"><p class="card-text cd-t">Selecione o arquivo que deseja enviar.</p> <button type="submit" class="btn btn-primary botao-sub cd-t">Enviar</button></div>
			</div>
